...
// once at chat-creation time rather than collected as an answer — {{referrerNote}} and
// {{leadSummary}} (Heseos's own tenant only, blank for everyone else) and {{attributionCity}}
// (whatever city HESEOS already knows for this chat's QR/referral link — see
