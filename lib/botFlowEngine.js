...
import { syncLeadField, finalizeHeseosLead, scheduleHeseosDemo, evaluateLeadRedirect, evaluateChatRedirect, appendHeseosLeadHistory, createHeseosFollowUpLead, submitHeseosRating } from '@/lib/heseosLeadSync';
...
async function endHandoff(tenant, chat, closingText, historyEvent) {
  ...
  const { demoDate, demoTime, demoAddress, newRequirement, rating, ratingRole, ratingComment, ratingEmployeeName, ...restAnswers } = chat.answers || {};
