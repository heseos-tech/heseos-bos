...
// auth guard, then the page itself) share one actual DB round trip instead of two — this was
// previously the single biggest cause of "every tap feels slow" in the Team/Partner apps, since
// every navigation re-ran this from scratch in both the shared layout and the page.
...
// See getEmployee() above for why this is wrapped in cache().
