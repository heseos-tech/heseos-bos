...
async function createLeadFromWhatsApp({ phone, name, partnerId }) {
  ...
  lead.history = pushHistory(lead, { event: 'Lead Submitted', by: partnerId ? `partner:${partnerId}` : 'whatsapp', note: 'WhatsApp QR' });
