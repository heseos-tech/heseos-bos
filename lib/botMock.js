...
// live WhatsApp webhook here); wa_chats/wa_messages already do this for real for Heseos's own
// single-number Team Inbox (lib/waInbound.js) — this is the multi-tenant, self-service sibling.
//
// direction follows the same convention as wa_messages: 'in' = the customer wrote it (inbound
// to the business), 'out' = the business/bot wrote it (outbound to the customer) — see
// lib/waInbound.js / components/InboxView.jsx for the real-number equivalent.
