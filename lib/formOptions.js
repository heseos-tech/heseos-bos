...
// Product catalogue categories used to live here as a fixed list — they're now admin-editable
// (Admin -> Products -> Manage Categories) and live in the `settings` table instead, see
// lib/productCategories.js (getProductCategories/addProductCategory/removeProductCategory) and
// its GET-only mirrors at app/api/product-categories and app/api/admin/product-categories.
