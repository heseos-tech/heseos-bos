...
// this chat's partnerCity was already resolved at chat-creation time (a genuine qr_partner scan
// — see lib/attribution.js's partnerCityFor) — everyone else falls straight through to the
// node's normal 'default' edge, unchanged.
const CHAT_CONDITIONS = {
  hasPartnerCity: (chat) => !!(chat && chat.partnerCity),
};
